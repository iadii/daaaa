...
def preprocess_text(text):
    ...
    # Include single-character answers in the result
    words = [lemmatizer.lemmatize(word) for word in words if (len(word) == 1 or (word not in stop_words and pattern.match(word)))]
    return ' '.join(words)
